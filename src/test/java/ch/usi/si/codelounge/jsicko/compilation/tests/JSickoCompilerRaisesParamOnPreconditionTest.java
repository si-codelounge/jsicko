...
public class JSickoCompilerRaisesParamOnPreconditionTest extends JSickoAbstractCompilerErrorTest {
    ...
    protected String getQualifiedClassName() {
        return "ch.usi.si.codelounge.jsicko.compilation.tests.RaisesParamOnPrecondition";
    }

    @Override
    protected String getFileName() {
        return "RaisesParamOnPrecondition.java";
    }
    ...
    protected String getExpectedDiagnosticCode() {
        return "jsicko.err.raises.on.precondition";
    }
    ...
    protected String[] getExpectedDiagnosticArguments() {
        return new String[] { "clause raises_something(java.lang.RuntimeException raises) in RaisesParamOnPrecondition#voidMethod()" };
    }
