...
public class JSickoCompilerInvariantWithParameterTest extends JSickoAbstractCompilerErrorTest {

    @Override
    protected String getQualifiedClassName() {
        return "ch.usi.si.codelounge.jsicko.compilation.tests.InvariantWithParameter";
    }

    @Override
    protected String getFileName() {
        return "InvariantWithParameter.java";
    }
    ...
    protected String getExpectedDiagnosticCode() {
        return "jsicko.err.invariant.non.zero.arity";
    }
    ...
    protected String[] getExpectedDiagnosticArguments() {
        return new String[] { "invariant_with_param" };
    }
}
