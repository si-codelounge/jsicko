...
public class JSickoCompilerInvariantIsStaticTest extends JSickoAbstractCompilerErrorTest {

    @Override
    protected String getQualifiedClassName() {
        return "ch.usi.si.codelounge.jsicko.compilation.tests.InvariantIsStatic";
    }

    @Override
    protected String getFileName() {
        return "InvariantIsStatic.java";
    }
    ...
    protected String getExpectedDiagnosticCode() {
        return "jsicko.err.invariant.is.static";
    }
    ...
    protected String[] getExpectedDiagnosticArguments() {
        return new String[] { "static_invariant" };
    }
}
