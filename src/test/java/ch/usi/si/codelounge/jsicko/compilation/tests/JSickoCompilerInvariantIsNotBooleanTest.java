...
public class JSickoCompilerInvariantIsNotBooleanTest extends JSickoAbstractCompilerErrorTest {

    @Override
    protected String getQualifiedClassName() {
        return "ch.usi.si.codelounge.jsicko.compilation.tests.InvariantIsNotBoolean";
    }

    @Override
    protected String getFileName() {
        return "InvariantIsNotBoolean.java";
    }
    ...
    protected String getExpectedDiagnosticCode() {
        return "jsicko.err.invariant.is.not.boolean";
    }
    ...
    protected String[] getExpectedDiagnosticArguments() {
        return new String[] { "non_boolean_invariant", "String" };
    }
}
