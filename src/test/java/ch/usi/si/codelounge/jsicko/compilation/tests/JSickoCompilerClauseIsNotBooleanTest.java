...
public class JSickoCompilerClauseIsNotBooleanTest extends JSickoAbstractCompilerErrorTest {
    ...
    protected String getQualifiedClassName() {
        return "ch.usi.si.codelounge.jsicko.compilation.tests.ClauseIsNotBoolean";
    }

    @Override
    protected String getFileName() {
        return "ClauseIsNotBoolean.java";
    }
    ...
    protected String getExpectedDiagnosticCode() {
        return "jsicko.err.clause.is.not.boolean";
    }
    ...
    protected String[] getExpectedDiagnosticArguments() {
        return new String[] { "Postcondition clause nothing in ImplementationContract#shouldBePure(double)", "nothing", "void" };
    }
