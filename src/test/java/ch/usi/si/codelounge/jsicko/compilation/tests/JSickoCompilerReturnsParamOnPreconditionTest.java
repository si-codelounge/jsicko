...
public class JSickoCompilerReturnsParamOnPreconditionTest extends JSickoAbstractCompilerErrorTest {

    @Override
    protected String getQualifiedClassName() {
        return "ch.usi.si.codelounge.jsicko.compilation.tests.ReturnsParamOnPrecondition";
    }

    @Override
    protected String getFileName() {
        return "ReturnsParamOnPrecondition.java";
    }
    ...
    protected String getExpectedDiagnosticCode() {
        return "jsicko.err.returns.on.precondition";
    }
    ...
    protected String[] getExpectedDiagnosticArguments() {
        return new String[] { "clause returns_something(java.lang.Object returns) in ReturnsParamOnPrecondition#voidMethod()" };
    }
