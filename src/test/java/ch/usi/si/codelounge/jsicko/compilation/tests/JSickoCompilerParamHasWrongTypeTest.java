...
public class JSickoCompilerParamHasWrongTypeTest extends JSickoAbstractCompilerErrorTest {

    @Override
    protected String getQualifiedClassName() {
        return "ch.usi.si.codelounge.jsicko.compilation.tests.ParamHasWrongType";
    }

    @Override
    protected String getFileName() {
        return "ParamHasWrongType.java";
    }
    ...
    protected String[] getExpectedDiagnosticArguments() {
        return new String[] { "name", "java.lang.String", "int", "clause precondition(int name) in ParamHasWrongType#voidMethod(java.lang.String name)" };
    }
