...
public class JSickoCompilerReturnsParamOnVoidMethodTest extends JSickoAbstractCompilerErrorTest {

    @Override
    protected String getQualifiedClassName() {
        return "ch.usi.si.codelounge.jsicko.compilation.tests.ReturnsParamOnVoidMethod";
    }

    @Override
    protected String getFileName() {
        return "ReturnsParamOnVoidMethod.java";
    }
    ...
    protected String getExpectedDiagnosticCode() {
        return "jsicko.err.returns.on.void.method";
    }
    ...
    protected String[] getExpectedDiagnosticArguments() {
        return new String[] { "clause returns_something(java.lang.Object returns) in ReturnsParamOnVoidMethod#voidMethod()" };
    }
